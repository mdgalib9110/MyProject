...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='galib@9110',db='cv')
...
def run():
    ...
    link = '<b>Built with 🤍 by <a href="https://www.linkedin.com/in/er-galib-4236b9240/" style="text-decoration: none; color: #021659;">GALIB & MOIN</a></b>' 
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            Built with 🤍 by
            <a href="https://www.linkedin.com/in/er-galib-4236b9240/" style="text-decoration: none; color: grey;">GALIB</a> through streamlit
        </p>
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            if ad_user == 'admin' and ad_password == 'admin@resume-Enhancer':
                ...
                st.success("Welcome GALIB ! Total %d " % values + " User's Have Used Our Tool : )")                
